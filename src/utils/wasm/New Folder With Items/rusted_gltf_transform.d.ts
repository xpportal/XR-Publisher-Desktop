...
* @returns {Promise<any>}
*/
export function add_xmp_metadata(input: Uint8Array, author: string): Promise<any>;
/**
* @param {Uint8Array} input
* @returns {Promise<any>}
*/
export function optimize_textures(input: Uint8Array): Promise<any>;
/**
* @param {Uint8Array} input
* @returns {Promise<any>}
*/
...
export interface InitOutput {
  ...
  readonly add_xmp_metadata: (a: number, b: number, c: number) => number;
  readonly optimize_textures: (a: number) => number;
