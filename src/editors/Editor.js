...
function Editor() {
	...
	this.signals = {
		...
		// XR Publisher specific signals
		xrPublisherApiKeyNeeded: new Signal(),
		xrPublisherApiKeyChanged: new Signal(),
		...
		xrPublisherAdded: new Signal(),
		xrPublisherChanged: new Signal(),
		xrPublisherRemoved: new Signal(),

		// Asset Drawer-related
		assetDrawerResized: new Signal(),
		toyboxApiKeyChanged: new Signal(),
...
Editor.prototype = {
	...
	addXrPublisher: function ( object, parent, index ) {
		...
		this.signals.xrPublisherAdded.dispatch( object );
		this.signals.sceneGraphChanged.dispatch();
