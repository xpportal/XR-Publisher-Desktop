...
class Selector {
	...
	select( object ) {
		...
		let uuid = null;
		// ensure the object is at the root of the scene and if not, traverse the parent to the top to select that item
		if ( object !== null && object.parent !== this.editor.scene ) {
