...
class SetPositionCommand extends Command {
	...
	execute() {
		...
		if( this.object.userData.type === "spawnpoint" ){
			this.object.userData.properties.positionX = this.newPosition.x;
			this.object.userData.properties.positionY = this.newPosition.y;
			this.object.userData.properties.positionZ = this.newPosition.z;
		}
