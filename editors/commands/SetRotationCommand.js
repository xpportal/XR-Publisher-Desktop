...
class SetRotationCommand extends Command {
	...
	execute() {
		...
		if( this.object.userData.type === "spawnpoint" ){
			this.object.userData.properties.rotationX = this.newRotation.x;
			this.object.userData.properties.rotationY = this.newRotation.y;
			this.object.userData.properties.rotationZ = this.newRotation.z;
		}
