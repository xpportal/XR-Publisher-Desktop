function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'command/AddXrPublisher': 'Add XR Publisher',

			'assetDrawer/models': 'Toybox',
			'assetDrawer/textures': 'Textures',
			'assetDrawer/scenes': 'Scenes',
			...
			'sidebar/spawnpoint': 'SPAWN POINT',
			'sidebar/text': 'TEXT',
			'menubar/add/text': 'Text',
			'sidebar/geometry/text': 'Text',
			'sidebar/geometry/fontSize': 'Font Size',
			'sidebar/geometry/color': 'Color',
			'sidebar/geometry/alignX': 'Align X',
			'sidebar/geometry/alignY': 'Align Y',
			'sidebar/geometry/text/positionX': 'Position X',
			'sidebar/geometry/text/positionY': 'Position Y',
			'sidebar/geometry/text/positionZ': 'Position Z',
			'sidebar/geometry/text/rotationX': 'Rotation X',
			'sidebar/geometry/text/rotationY': 'Rotation Y',
			'sidebar/geometry/text/rotationZ': 'Rotation Z',
			'sidebar/geometry/text/scaleX': 'Scale X',
			'sidebar/geometry/text/scaleY': 'Scale Y',
			'sidebar/geometry/text/scaleZ': 'Scale Z',
			'sidebar/geometry/text/content': 'Text Content',
			'sidebar/geometry/text/color': 'Text Color',
			'sidebar/geometry/text/url': 'Destination URL',
			'sidebar/geometry/text/collidable': 'Collidable',
			...
			'sidebar/properties/xrPublisher': 'XR Publisher',
